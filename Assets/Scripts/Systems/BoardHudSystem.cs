...
{
    /// <summary>Pushes the move counter and Undo/Redo availability to the gameplay HUD when they change.</summary>
    public class BoardHudSystem : IEcsRunSystem
    {
        ...
        public void Run()
        {
            ...
            var hud = new BoardHud(history.Seed, history.Moves.Count,
                ready && history.Moves.Count > 0, ready && history.Undone.Count > 0);
